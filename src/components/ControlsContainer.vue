<template>
  <div class="controlsContainer">
    <svg
      ...
      class="leftArrow"
      ref="leftArrow"
      @mouseleave="removecolor(this.$refs.leftArrow)"
      @mouseover="changecolor(this.$refs.leftArrow)"
      viewBox="0 0 24 24"
      fill="none"
    ...
    <svg
      ...
      class="rightArrow"
      ref="rightArrow"
      @mouseleave="removecolor(this.$refs.rightArrow)"
      @mouseover="changecolor(this.$refs.rightArrow)"
      viewBox="0 0 24 24"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
    ...
    <svg
      ...
      class="leftArrow"
      ref="leftArrow"
      @touchend="removecolor(this.$refs.leftArrow)"
      @touchstart="changecolor(this.$refs.leftArrow)"
      viewBox="0 0 24 24"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
    ...
    <svg
      ...
      class="rightArrow"
      ref="rightArrow"
      @touchend="removecolor(this.$refs.rightArrow)"
      @touchstart="changecolor(this.$refs.rightArrow)"
      viewBox="0 0 24 24"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
